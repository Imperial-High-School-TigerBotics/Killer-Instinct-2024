...
public class SwerveModule {
    ...
    public double getEncoderAbsolutePosition() {
        return Math.IEEEremainder(Units.rotationsToDegrees(absoluteEncoder.getAbsolutePosition().getValueAsDouble()), 360);
    }

    public double getAbsoluteEncoderDeg() {
        double angle = Units.rotationsToDegrees(absoluteEncoder.getAbsolutePosition().getValueAsDouble());
    ...
    public double getRawAbsoluteEncoder(){
        double absoluteAngle = Units.rotationsToDegrees(absoluteEncoder.getAbsolutePosition().getValueAsDouble());
